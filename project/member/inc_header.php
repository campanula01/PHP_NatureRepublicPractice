...
<head>
    ...
    <title><?= (isset($g_title) &&$g_title='')?$g_title:'빡독' ?></title>
    <script src="https://kit.fontawesome.com/f65d4a27bd.js" crossorigin="anonymous"></script>
...
<script>
  document.addEventListener("DOMContentLoaded",()=>{
        ...
        //검색버튼
        const btn_search_full = document.querySelector("#btn_search_full");
      btn_search_full.addEventListener("click",()=>{
        ...
        self.location.href = './board.php?bcode=etyhdd&sn=1&sf='+search.value;
    ...
    <div class="container">
        ...
        <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
            ...
            <form class="col-12 col-lg-auto mb-3 mb-lg-0 me-lg-3 d-flex" role="search">
              ...
              <button type="button" class="btn btn-green3" id="btn_search_full"><i class="fa-solid fa-magnifying-glass"></i></button>
            </form>
            ...
            <div class="text-end">
              ...
              <?php 
                if($ses_level ==10){
              ?>
                <button type="button" class="btn btn-dark " id="adminpage">관리 페이지로 이동</button>
              <?php
                }else{
                ?>
              <button type="button" class="btn btn-green1 " id="mypage">회원정보</button>
              ...
              <?php  
                ...
                ?>
                <button type="button" class="btn btn-light  me-2" id="login">로그인</button>
                <button type="button" class="btn btn-green1  " id="stipulation">회원가입</button>
            <?php
              }
              ?>
                </div>
